...
public class ComplexStorage extends Contract {
    ...
    public RemoteFunctionCall<DynamicStruct> getFoo() {
        final Function function = new Function(FUNC_GETFOO,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<DynamicStruct>() {
                }));
        return executeRemoteCallSingleValueReturn(function);
    }

    public RemoteFunctionCall<TransactionReceipt> setFoo(DynamicStruct _toSet) {
    ...
    public RemoteFunctionCall<TransactionReceipt> setBar(DynamicStruct _toSet) {
        final Function function = new Function(
                FUNC_SETBAR,
                Arrays.<Type>asList(_toSet),
                Collections.<TypeReference<?>>emptyList());
    ...
    public List<AccessEventResponse> getAccessEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._foo = (DynamicStruct) eventValues.getNonIndexedValues().get(0);
            typedResponse._bar = (DynamicStruct) eventValues.getNonIndexedValues().get(1);
    ...
    public static class AccessEventResponse extends BaseEventResponse {
        ...
        public DynamicStruct _foo;

        public DynamicStruct _bar;
    }
}
