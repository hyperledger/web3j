 ...
 * <p>Please use the <a href="https://docs.web3j.io/command_line.html">web3j command line tools</a>, or {@link org.web3j.codegen.SolidityFunctionWrapperGenerator} to update.
 *
...
public final class Arrays extends Contract {
    ...
    public RemoteCall<TransactionReceipt> fixedReverse(StaticArray<Uint256> input) {
    ...
    public RemoteCall<TransactionReceipt> dynamicReverse(DynamicArray<Uint256> input) {
        Function function = new Function("dynamicReverse", java.util.Arrays.<Type>asList(input), Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public static RemoteCall<Arrays> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) {
        return deployRemoteCall(Arrays.class, web3j, credentials, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }

    public static RemoteCall<Arrays> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) {
        return deployRemoteCall(Arrays.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }
