...
public final class Arrays extends Contract {
    ...
    public TransactionReceipt fixedReverse(List<BigInteger> input) throws IOException, TransactionException {
        Function function = new Function(
                "fixedReverse", 
                java.util.Arrays.<Type>asList(new org.web3j.abi.datatypes.StaticArray<org.web3j.abi.datatypes.generated.Uint256>(
                        org.web3j.abi.Utils.typeMap(input, org.web3j.abi.datatypes.generated.Uint256.class))), 
                Collections.<TypeReference<?>>emptyList());
        return executeTransaction(function);
    }

    public TransactionReceipt dynamicReverse(List<BigInteger> input) throws IOException, TransactionException {
        Function function = new Function(
                "dynamicReverse", 
    ...
    public static Arrays deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) throws IOException, TransactionException {
        return deploy(Arrays.class, web3j, credentials, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }

    public static Arrays deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) throws IOException, TransactionException {
        return deploy(Arrays.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "", initialWeiValue);
    }
