...
public class TemplatesAsString {
    final static String javaTemplate =
            "package <package_name>;\n" +
                    ...
                    "        }" +
                    "\n}\n";
    final static String gradleBuildTemplate =
            "plugins {\n" +
                    "    id 'java'\n" +
                    ...
                    "}\n";
    final static String gradleSettings =
            "pluginManagement {\n" +
                    "    repositories {\n" +
                    "        mavenCentral()\n" +
                    "        gradlePluginPortal()\n" +
    ...
    final static String solidityProject=
            "pragma solidity ^0.4.25;\n" +
                    ...
                    "}\n";
    final static String gradlewScript =
            "#!/usr/bin/env sh\n" +
                    "\n" +
                    "##############################################################################\n" +
                    "##\n" +
    ...
    final static String gradlewBatScript =
            "@if \"%DEBUG%\" == \"\" @echo off\n" +
                    "@rem ##########################################################################\n" +
                    "@rem\n" +
                    ...
                    "\n" +
                    ":omega\n";
    final static String gradleWrapperSettings =
