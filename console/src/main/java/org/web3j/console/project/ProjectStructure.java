...
public class ProjectStructure {
    ...
    private String createPath(final String root, final String projectName, final String test, final String java, final String packageName) {
        return createPath(root, projectName, test, java) + File.separator + packageName.replaceAll("[.]", File.separator);
    }

    private String createPath(final String root, final String projectName, final String main, final String java) {
        return root
                + File.separator
                + projectName
                + File.separator
