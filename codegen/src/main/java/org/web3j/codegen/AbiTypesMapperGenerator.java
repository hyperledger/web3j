...
public class AbiTypesMapperGenerator extends Generator {
    ...
    private void generate(String destinationDir) throws IOException {
        ...
        MethodSpec getTypeSpec = getTypeMethodSpec(typesPackageName,
                primitiveTypesPackageName, autoGeneratedTypesPackageName);
    ...
    private MethodSpec.Builder addPrimitiveTypes(MethodSpec.Builder builder, String packageName) {
        ...
        builder = addStatement(builder, packageName,
                Char.class.getSimpleName().toLowerCase(), Char.class.getSimpleName());

        builder = addStatement(builder, packageName,
                Double.class.getSimpleName().toLowerCase(), Double.class.getSimpleName());

        builder = addStatement(builder, packageName,
                Float.class.getSimpleName().toLowerCase(), Float.class.getSimpleName());

        builder = addStatement(builder, packageName,
                org.web3j.abi.datatypes.primitive.Int.class
                        .getSimpleName().toLowerCase(),
                org.web3j.abi.datatypes.primitive.Int.class.getSimpleName());

        builder = addStatement(builder, packageName,
                Long.class.getSimpleName().toLowerCase(), Long.class.getSimpleName());

        builder = addStatement(builder, packageName,
                Short.class.getSimpleName().toLowerCase(), Short.class.getSimpleName());
