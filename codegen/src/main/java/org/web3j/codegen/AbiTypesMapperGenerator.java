...
public class AbiTypesMapperGenerator extends Generator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 1) {
            ...
            abiTypesMapperGenerator.generate(
                    System.getProperty("user.dir") + "/abi/src/main/java/");
        }
    }
    ...
    private MethodSpec getTypeMethodSpec(
        ...
        // TODO[Sam]: Add support for tuples
        // builder = addTupleTypes(builder, something); // AbiTypes.java: FOO Unsupported type encountered: tuple
