    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n" +
                        ...
                        "    java.util.List<org.web3j.protocol.core.methods.response.EventValuesWithLog> valueList = extractEventParameters(event, transactionReceipt);\n" +
                        "    java.util.ArrayList<TransferEventResponse> responses = new java.util.ArrayList<TransferEventResponse>(valueList.size());\n" +
                        "    for (org.web3j.protocol.core.methods.response.EventValuesWithLog eventValues : valueList) {\n" +
                        ...
                        "        org.web3j.protocol.core.methods.response.EventValuesWithLog eventValues = extractEventParameters(event, log);\n" +
                        "        TransferEventResponse typedResponse = new TransferEventResponse();\n" +
