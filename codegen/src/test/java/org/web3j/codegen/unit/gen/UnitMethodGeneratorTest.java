    ...
    public void testThatDeployMethodWasGenerated() {
        String deployTemplate =
                " @BeforeEach\n"
                        ...
                        + "    greeter = Greeter.deploy(web3j,transactionManager,contractGasProvider,\"REPLACE_ME\").send();\n"
                        + "  }";
        ...
        assertTrue(
                classAsString.contains(
                        " @Test\n"
                                ...
                                + "    // Make sure to change the placeholder arguments.;\n"
                                + "    greeter = Greeter.load(\"REPLACE_ME\",web3j,transactionManager,contractGasProvider);\n"
                                + "  }"));
    }
        ...
        assertTrue(
                classAsString.contains(
                        "@Test\n"
                                ...
                                + "    // Make sure to change the placeholder arguments.;\n"
                                + "    TransactionReceipt transactionReceiptVar = greeter.kill().send();\n"
                                + "  }"));
    }
        ...
        assertTrue(
                classAsString.contains(
                        "@Test\n"
                                ...
                                + "    // Make sure to change the placeholder arguments.;\n"
                                + "    TransactionReceipt transactionReceiptVar = greeter.newGreeting(\"REPLACE_ME\").send();\n"
                                + "  }"));
    }
        ...
        assertTrue(
                classAsString.contains(
                        "@Test\n"
                                ...
                                + "    // Make sure to change the placeholder arguments.;\n"
                                + "    String stringVar = greeter.greet().send();\n"
                                + "  }"));
    }
}
