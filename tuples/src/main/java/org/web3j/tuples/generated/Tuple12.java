...
public final class Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> implements Tuple {
    ...
    public Tuple12(final T1 value1, final T2 value2, final T3 value3, final T4 value4, final T5 value5, final T6 value6, final T7 value7, final T8 value8, final T9 value9, final T10 value10, final T11 value11, final T12 value12) {
        this.value1 = value1;
        this.value2 = value2;
        this.value3 = value3;
        this.value4 = value4;
    ...
    public boolean equals(final Object o) {
        ...
        final Tuple12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> tuple12 = (Tuple12<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
