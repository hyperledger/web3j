...
public abstract class IntType extends NumericType {
    ...
    public IntType(final String typePrefix, final int bitSize, final BigInteger value) {
    ...
    private static boolean isValidBitSize(final int bitSize) {
        return bitSize % 8 == 0 && bitSize > 0 && bitSize <= MAX_BIT_LENGTH;
    }

    private static boolean isValidBitCount(final int bitSize, final BigInteger value) {
