...
public class EeaTransactionManager extends PrivateTransactionManager {
    ...
    public EthSendTransaction sendTransaction(
        ...
        final List<Base64String> privateForBase64 = new ArrayList<>(privateFor.size());
        for (int i = 0; i < privateFor.size(); i++) {
            privateForBase64.set(i, Base64String.wrap(privateFor.get(i)));
        }
