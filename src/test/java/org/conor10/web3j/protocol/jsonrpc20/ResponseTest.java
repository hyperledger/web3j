...
import org.conor10.web3j.Web3jService;
import org.conor10.web3j.methods.*;
...
public class ResponseTest {
    ...
    public void testNetPeerCount() throws IOException {
        ...
        assertThat(netPeerCount.getQuantity(), is(2L));
    }
    ...
    public void testEthHashrate() {
        ...
        assertThat(ethHashrate.getHashrate(), is(906L));
    }
    ...
    public void testEthGasPrice() {
        ...
        assertThat(ethGasPrice.getGasPrice(), is(10000000000000L));
    }
    ...
    public void testEthBlockNumber() {
        ...
        assertThat(ethBlockNumber.getBlockNumber(), is(1207L));
    }
    ...
    public void testEthGetBalance() {
        ...
        assertThat(ethGetBalance.getBalance(), is(158972490234375000L));
    }
