...
public class AbiTypesMapperGenerator extends Generator {
    ...
    private void generate() throws IOException {
        ...
        builder = builder.beginControlFlow("if ($L == null || $L.equals(\"\"))", TYPE, TYPE)
        ...
        builder = builder.beginControlFlow("else ")
                .addStatement("throw new $T($S)",
                        UnsupportedOperationException.class,
    ...
    private MethodSpec.Builder addStatement(MethodSpec.Builder builder, String packageName,
        ...
        return builder.beginControlFlow(
                "else if (\"$L\".equals($L))", typeName, TYPE)
