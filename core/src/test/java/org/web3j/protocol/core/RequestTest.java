...
public class RequestTest extends RequestTester {
    ...
    public void testNetVersion() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"net_version\",\"params\":[]}");
    }
    ...
    public void testNetListening() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"net_listening\",\"params\":[]}");
    }
    ...
    public void testNetPeerCount() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\",\"params\":[]}");
    }
    ...
    public void testEthSyncing() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_syncing\",\"params\":[]}");
    }
    ...
    public void testEthCoinbase() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_coinbase\",\"params\":[]}");
    }
    ...
    public void testEthMining() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_mining\",\"params\":[]}");
    }
    ...
    public void testEthHashrate() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_hashrate\",\"params\":[]}");
    }
    ...
    public void testEthGasPrice() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_gasPrice\",\"params\":[]}");
    }
    ...
    public void testEthAccounts() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_accounts\",\"params\":[]}");
    }
    ...
    public void testEthBlockNumber() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_blockNumber\",\"params\":[]}");
    }
    ...
    public void testEthGetBlockTransactionCountByHash() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByHash\",\"params\":[\"0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthGetUncleCountByBlockHash() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_getUncleCountByBlockHash\",\"params\":[\"0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthSendRawTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_sendRawTransaction\",\"params\":[\"0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthGetTransactionByBlockHashAndIndex() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockHashAndIndex\",\"params\":[\"0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331\",\"0x0\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthGetWork() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"eth_getWork\",\"params\":[]}");
    }
    ...
    public void testShhNewIdentity() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"shh_newIdentity\",\"params\":[]}");
    }
    ...
    public void testShhHasIdentity() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"shh_hasIdentity\",\"params\":[\"0x04f96a5e25610293e42a73908e93ccc8c4d4dc0edcfa9fa872f50cb214e08ebf61a03e245533f97284d442460f2998cd41858798ddfd4d661997d3940272b717b1\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testShhNewGroup() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"shh_newGroup\",\"params\":[]}");
    }
    ...
    public void testShhAddToGroup() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"shh_addToGroup\",\"params\":[\"0x04f96a5e25610293e42a73908e93ccc8c4d4dc0edcfa9fa872f50cb214e08ebf61a03e245533f97284d442460f2998cd41858798ddfd4d661997d3940272b717b1\"]}");
        //CHECKSTYLE:ON
    }
    ...
    public void testShhNewFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"shh_newFilter\",\"params\":[{\"topics\":[\"0x12341234bf4b564f\"],\"to\":\"0x04f96a5e25610293e42a73908e93ccc8c4d4dc0edcfa9fa872f50cb214e08ebf61a03e245533f97284d442460f2998cd41858798ddfd4d661997d3940272b717b1\"}]}");
        //CHECKSTYLE:ON
    }
