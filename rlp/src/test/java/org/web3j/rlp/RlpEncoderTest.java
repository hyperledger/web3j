...
public class RlpEncoderTest {
    ...
    public void testEncode() {
        ...
        assertThat(
                RlpEncoder.encode(RlpString.create(new byte[] {})), is(new byte[] {(byte) 0x80}));
        ...
        assertThat(
                RlpEncoder.encode(RlpString.create(BigInteger.ZERO)), is(new byte[] {(byte) 0x80}));

        // https://github.com/paritytech/parity-common/blob/master/rlp/tests/tests.rs#L237
        assertThat(
                RlpEncoder.encode(RlpString.create(new byte[] {0})), is(new byte[] {(byte) 0x00}));
        ...
        assertThat(RlpEncoder.encode(RlpString.create(encodeMe)), is(expectedEncoding));
    }
}
